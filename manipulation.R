...
fac11<-read.csv("FS2011.csv",stringsAsFactors=TRUE)
fac14<-read.csv("TRIP_FacultySurvey_2014_Full_2.0.1.csv",stringsAsFactors=TRUE)
fac17<-read.csv("TRIP_FacultySurvey_2017_FULL_Clean_1.0.csv",stringsAsFactors=TRUE,encoding="UTF-8")
...
names(qid_overtime)[3:8]<-c("2004","2006","2008","2011","2014","2017")
